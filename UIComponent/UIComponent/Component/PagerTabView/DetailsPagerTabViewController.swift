//
//  DetailsPagerTabViewController.swift
//  Common
//
...
/**
 [UI 제플린에서 보기](https://zpl.io/bW611e1)
 */

open class DetailsPagerTabViewController: ButtonBarPagerTabStripViewController {
  
  // MARK: - UI Properties
  
  public lazy var pagerTabView: PagerTabView = {
    let pagerTabView = PagerTabView()
    pagerTabView.setupPargerViewStyle(.details, with: buttonBarView)
    return pagerTabView
  }()
  ...
  private func setupPagerTabViewStyle() {
    ...
    settings.style.buttonBarMinimumInteritemSpacing = 24
